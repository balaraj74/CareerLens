...
// imports intentionally omitted — this service currently returns curated static lists

export interface CourseOpportunity {
  id: string;
  title: string;
  provider: string;
  platform: 'coursera' | 'udacity' | 'edx' | 'google-skills' | 'linkedin-learning';
  description: string;
  duration: string;
 ...
 */
export async function fetchLearningOpportunities(): Promise<CourseOpportunity[]> {
  const opportunities: CourseOpportunity[] = [];
 ...
 */
async function fetchGoogleSkillsBoost(): Promise<CourseOpportunity[]> {
  const courses: CourseOpportunity[] = [
    {
 ...
 */
async function fetchCourseraPublicCourses(): Promise<CourseOpportunity[]> {
  const courses: CourseOpportunity[] = [
    {
 ...
 */
async function fetchFreeCertifications(): Promise<CourseOpportunity[]> {
  const freeCerts: CourseOpportunity[] = [
    {
 ...
 */
export async function searchCoursesBySkill(skill: string): Promise<CourseOpportunity[]> {
