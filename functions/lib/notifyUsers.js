...
exports.notifyUsersTrigger = exports.notifyDailyDigest = exports.notifyNewMentor = exports.notifyNewCourse = exports.notifyNewReview = void 0;
...
async function sendPushNotification(userId, payload) {
    try {
        ...
        const pushEnabled = (userData === null || userData === void 0 ? void 0 : userData.pushNotifications) !== false; // Default true
        ...
        const message = {
            token: fcmToken,
            notification: Object.assign({ title: payload.title, body: payload.body }, (payload.imageUrl && { imageUrl: payload.imageUrl })),
            data: payload.data || {},
            android: {
                priority: 'high',
                notification: {
 ...
 */
async function sendBatchNotifications(userIds, payload) {
    let success = 0;
    let failed = 0;
    ...
    for (let i = 0; i < userIds.length; i += chunkSize) {
        ...
        const results = await Promise.all(chunk.map(userId => sendPushNotification(userId, payload)));
 ...
 */
exports.notifyNewCourse = functions.firestore
 ...
 */
exports.notifyNewMentor = functions.firestore
 ...
 */
exports.notifyDailyDigest = functions.pubsub
    .schedule('0 9 * * *')
 ...
 */
exports.notifyUsersTrigger = functions.https.onRequest(async (req, res) => {
    try {
        const userId = req.query.userId;
        const title = req.query.title || 'Test Notification';
        const body = req.query.body || 'This is a test notification from CareerLens';
        if (!userId) {
            res.status(400).json({
                success: false,
...
//# sourceMappingURL=notifyUsers.js.map