...
export function Nav({ handleLogout, isLoggingOut, user }: NavProps) {
  ...
  return (
    <motion.div
      ...
      className="fixed left-0 top-0 h-full w-56 bg-card backdrop-blur-xl 
    ...
    >
      <div className="flex flex-col items-center text-center py-4 mb-4">
        ...
        <h2 className="text-lg text-white font-bold truncate w-full">
      ...
      <Button
        ...
        className="w-full justify-start p-3 text-base text-muted-foreground hover:bg-destructive/20 hover:text-white mt-4"
      >
